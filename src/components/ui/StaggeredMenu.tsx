    ...
    return (
        <div
            ...
            style={{
                ...
                height: isFixed ? (open ? '100vh' : '1px') : '100%',
                zIndex: 1000,
                pointerEvents: 'none',
                overflow: 'visible'
            }}
        >
            ...
            >
                ...
                >
                    <div className="sm-logo select-none pointer-events-auto" style={{ display: 'flex', alignItems: 'center', pointerEvents: 'auto' }} aria-label="Logo">
                        <img
                            src={logoUrl || '/Logo-withoutbg.png'}
                            alt="Logo"
                    ...
                    >
                        <span
                            ...
                            aria-hidden="true"
                        >
                            <span ref={textInnerRef} className="sm-toggle-textInner" style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
                                {textLines.map((l, i) => (
                                    <span className="sm-toggle-line" style={{ display: 'block', height: '1em', lineHeight: 1 }} key={i}>
                                        {l}
                                    </span>
                                ))}
                            </span>
            ...
            <style>{`
.sm-scope .staggered-menu-header { position: fixed; top: 0; left: 0; width: 100%; height: auto; display: flex; align-items: center; justify-content: space-between; padding: 24px 80px; pointer-events: none; z-index: 1100; }
.sm-scope .sm-logo, .sm-scope .sm-toggle { pointer-events: auto !important; position: relative; z-index: 1200; }
.sm-scope .sm-logo-img { display: block; height: 32px; width: auto; object-fit: contain; }
.sm-scope .sm-toggle:focus-visible { outline: 2px solid #ffffffaa; outline-offset: 4px; border-radius: 4px; }
.sm-scope .sm-toggle-textWrap { position: relative; margin-right: 0.5em; display: inline-block; height: 1em; overflow: hidden; white-space: nowrap; width: auto; min-width: 60px; text-align: right; }
.sm-scope .sm-toggle-textInner { display: flex; flex-direction: column; line-height: 1; }
.sm-scope .sm-toggle-line { display: block; height: 1em; line-height: 1; }
.sm-scope .sm-icon { position: relative; width: 14px; height: 14px; flex: 0 0 14px; display: inline-flex; align-items: center; justify-content: center; will-change: transform; }
.sm-scope .sm-panel-itemWrap { position: relative; overflow: hidden; line-height: 1; }
.sm-scope .sm-icon-line { position: absolute; left: 50%; top: 50%; width: 100%; height: 2px; background: currentColor; border-radius: 2px; transform: translate(-50%, -50%); will-change: transform; }
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; transform: translateX(100%); transition: transform 0.1s linear; }
...
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; transform: translateY(140%) rotate(10deg); }
